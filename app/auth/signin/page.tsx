...
import { Separator } from "@/components/ui/separator"; // Adicione com npx shadcn-ui@latest add separator
// --- FIM ---
...
export default function SignInPage() {
  ...
  const [isLoading, setIsLoading] = useState<boolean | 'google' | 'twitch' | 'credentials'>(false); // Estado de loading mais específico
  ...
  const handleOAuthSignIn = (provider: 'google' | 'twitch') => {
    setIsLoading(provider); // Define loading para o provider específico
  ...
  return (
     <div className="flex items-center justify-center min-h-screen bg-slate-100 px-4">
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
             <Button
                ...
                disabled={!!isLoading} // Desativa se qualquer loading estiver ativo
             >
             ...
             <Button
                variant="outline"
                className="w-full bg-[#6441a5] text-white hover:bg-[#583894]" // Estilo Twitch
        ...
        <CardFooter className="text-sm text-center block"> {/* Usa block para centralizar */}
          Não tem conta?{" "}

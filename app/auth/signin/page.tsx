...
// --- [NOVO] Força a renderização dinâmica da página ---
...
export default function SignInPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-100 px-4">
       {/* --- Envolve o formulário com Suspense --- */}
       <Suspense fallback={<div className="text-center p-10">A carregar formulário...</div>}> {/* Fallback melhorado */}
          <SignInForm />
       </Suspense>
       {/* --- [FIM NOVO] --- */}
    </div>
